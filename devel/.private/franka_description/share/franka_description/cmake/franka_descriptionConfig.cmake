...
if("TRUE" STREQUAL "TRUE")
  set(franka_description_SOURCE_PREFIX /home/pandanuc3/catkin_ws4/src/franka_ros/franka_description)
  set(franka_description_DEVEL_PREFIX /home/pandanuc3/catkin_ws4/devel/.private/franka_description)
  ...
  set(franka_description_INSTALL_PREFIX /home/pandanuc3/catkin_ws4/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pandanuc3/catkin_ws4/src/franka_ros/franka_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pandanuc3/catkin_ws4/devel/.private/franka_description/lib;/home/pandanuc3/catkin_ws4/devel/lib;/opt/ros/kinetic/lib)
